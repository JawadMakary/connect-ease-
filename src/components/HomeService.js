...
const HomeService = ({title,description}) => {
  return (
    <div class="cursor-pointer mb-5 group overflow-hidden p-5 duration-1000 hover:duration-1000 relative w-64 h-64 bg-[rgba(55, 65, 81, 0.2)]  rounded-xl">
      ...
      <div class="w-full h-full shadow-xl shadow-neutral-900 p-3 bg-gray-800 opacity-50 rounded-xl flex-col gap-2 flex justify-center">
