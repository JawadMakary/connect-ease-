      ...
      <header className="relative shadow-lg px-3 py-2">
        <nav className="flex justify-between">
          ...
          <div className="flex items-center gap-3">
            <div className={`navLinks duration-500 absolute md:static md:w-auto w-full md:h-auto h-[85vh] bg-white flex md:items-center gap-[1.5vw] top-[100%] ${isMenuOpen ? 'left-0' : 'left-[100%]'} px-5 md:py-0 py-5`}>
              <ul className="flex md:flex-row flex-col md:items-center md:gap-[2vw] gap-8">
                ...
                <li className="relative max-w-fit pr-3 md:pr-0 py-1 after:bg-gradient-to-r from-[#2b68e0] to-[#e710ea]  after:absolute after:h-1 after:w-0 after:bottom-0 after:left-0 hover:after:w-full after:transition-all after:duration-300"><a href="#">FAQ</a></li>
                <li className="relative max-w-fit pr-3 md:pr-0 py-1 after:bg-gradient-to-r from-[#2b68e0] to-[#e710ea]  after:absolute after:h-1 after:w-0 after:bottom-0 after:left-0 hover:after:w-full after:transition-all after:duration-300"><a href="#">Careers</a></li>
            ...
            <div className="flex items-center gap-2">
              ...
              <p name="menu" onClick={onMenuToggle} className="text-[30px] cursor-pointer md:hidden">x</p>
            </div>
          </div>
        </nav>
      </header>
